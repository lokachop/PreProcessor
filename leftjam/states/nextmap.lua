...
LeftJam.States[STATE_NEXT_MAP].render = function()
    ...
    local col_s = linear_srgb_to_oklab({24, 24, 24})
    local col_f = linear_srgb_to_oklab({32, 128, 64})
    local steps = 128
    ...
    for i = 0, steps - 1 do
        ...
        love.graphics.setColor(colLerped[1] / 255, colLerped[2] / 255, colLerped[3] / 255, 0.95)
        love.graphics.rectangle("fill", 0, i * hDiv, w, hDiv)
    end
end
